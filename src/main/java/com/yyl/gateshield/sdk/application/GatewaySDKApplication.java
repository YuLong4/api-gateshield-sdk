package com.yyl.gateshield.sdk.application;
...
import com.yyl.gateshield.sdk.config.GatewaySDKServiceProperties;
...
public class GatewaySDKApplication implements BeanPostProcessor {
    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
        ...
        if (interfaces.length != 1){
            throw new GatewayException(bean.getClass().getName() + " 接口不唯一 " + JSON.toJSONString(interfaces));
        }
        ...
        logger.info("methods" + JSON.toJSONString(methods));
