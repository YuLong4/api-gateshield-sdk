package com.yyl.gateshield.sdk.domain.service;

import cn.hutool.http.HttpUtil;
import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.TypeReference;
import com.yyl.gateshield.sdk.GatewayException;
import com.yyl.gateshield.sdk.common.Result;
...
public class GatewayCenterService {
    ...
    public void doRegisterApplication(String address, String systemId, String systemName, String systemType, String systemRegistry) {
        ...
        String resultStr;
        try {
            resultStr = HttpUtil.post(address + "/wg/admin/register/registerApplication", paramMap);
        } catch (Exception e) {
    ...
    public void doRegisterApplicationInterface(String address, String systemId, String interfaceId, String interfaceName, String interfaceVersion) {
        ...
        String resultStr;
        try {
            resultStr = HttpUtil.post(address + "/wg/admin/register/registerApplicationInterface", paramMap);
        } catch (Exception e) {
    ...
    public void doRegisterApplicationInterfaceMethod(String address,
        ...
        String resultStr;
        try {
            resultStr = HttpUtil.post(address + "/wg/admin/register/registerApplicationInterfaceMethod", paramMap);
        } catch (Exception e) {
    ...
    public void doRegisterEvent(String address, String systemId) {
        ...
        String resultStr;
        try {
            resultStr = HttpUtil.post(address + "/wg/admin/register/registerEvent", paramMap);
        } catch (Exception e) {
